...
mcodes = [
    ...
    Mcode(
        code=29,
        desc="End of file being written; should be intercepted before getting here",
    ),
    ...
    Mcode(
        code=101,
        desc="Un-retract, generated by S3D if 'Include M101/101/103' is enabled",
    ),
    Mcode(code=102),
    ...
    Mcode(
        code=112,
        desc="Emergency stop - acted upon in Webserver, but also here in case it comes from USB etc.",
    ),
    Mcode(code=114),
    ...
    Mcode(
        code=200,
        desc="Set filament diameter for volumetric extrusion and enable/disable volumetric extrusion",
    ),
    ...
    Mcode(
        code=208,
        desc="Set/print maximum axis lengths. If there is an S parameter with value 1 then we set the min value, else we set the max value.",
    ),
    ...
    Mcode(
        code=226,
        desc="Synchronous pause, normally initiated from within the file being printed",
    ),
    ...
    Mcode(
        code=302,
        desc="Allow, deny or report cold extrudes and configure minimum extrusion/retraction temps",
    ),
    ...
    Mcode(
        code=502,
        desc="Revert to default 'factory settings' ignoring values in config-override.g",
    ),
