...
class TestMcode:
    ...
    def test(self, result):
        ...
        logging.debug("testing\n  {} {}\n  {} {}\n".format(type(result), result, type(self.result), self.result))
...
mcodes = [
    ...
    TestMcode(
        code=409,
        param='K"boards" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"boards" F"d2vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"directories" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"fans" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"global" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"heat" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"inputs" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(code=409, param='K"job" F"d99vn"', desc="Get object model values in JSON format"),
    TestMcode(
        code=409,
        param='K"limits" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"move" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"network" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"scanner" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"sensors" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"seqs" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"spindles" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"state" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"tools" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
        param='K"volumes" F"d99vn"',
        desc="Get object model values in JSON format",
    ),
    TestMcode(
        code=409,
...
def printKeys(parent, dic):
    ...
    if isinstance(dic, dict):
        for key, val in dic.items():
            ...
            print("{}, {}, {}".format(parent + "/" + key, type(val), val))
...
if __name__ == "__main__":
    logging.basicConfig(level=logging.DEBUG, format="*** %(asctime)s - %(message)s", filename=None)
